<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:31:"template/group/index/share.html";i:1667470116;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8"/>
...
<div id="idjshow"></div>  
		...
		<div class="qun"><img src="<?php echo $info['wxg_img']; ?>"/><p class="quntit" id="quntit"><?php echo $info['wxg_title']; ?></p><p class="num"><?php echo $info['wxg_subtitle']; ?></p></div>
