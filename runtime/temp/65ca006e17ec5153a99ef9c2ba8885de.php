...
$(".sub").click(function(){
	...
	$.ajax({
		type:"POST",
		url:"<?php echo url('rule/addgroup'); ?>",
		dataType:"json",
		data:{
			title:title,
			sort:_sort,
