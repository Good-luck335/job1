<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"template/substation/center/home.html";i:1660189960;s:69:"/www/wwwroot/47.119.114.223_92/template/substation/common_header.html";i:1655346642;s:66:"/www/wwwroot/47.119.114.223_92/template/substation/common_top.html";i:1655179780;s:69:"/www/wwwroot/47.119.114.223_92/template/substation/common_footer.html";i:1655179778;}*/ ?>
<!DOCTYPE html>
<html>
              ...
              <div class="layui-card-body">               
                    ...
                    <ul class="layui-row layui-col-space10">
                      ...
                      <li class="layui-col-xs4">
						<a href="javascript:;" onclick="#" class="layadmin-backlog-body">
                          <h3>抽佣比例</h3>
                          <?php if($fzinfo['su_s_id']==0): ?>
                          <p><cite><?php echo round($info['su_dk_cd'],2); ?> %</cite></p>
                          <?php else: ?>
                          <p><cite><?php echo round($info['su_dk_cd'] + $fzsinfo['su_dk_cd'] ,2); ?> %</cite></p>
                          <?php endif; ?>
                        </a>
                      </li>
                      ...
                      <li class="layui-col-xs4">
						<a href="javascript:;" onclick="#" class="layadmin-backlog-body">
                          <h3>点卡余额</h3>
                          <p><cite><?php echo round($info['su_dk'],2); ?></cite></p>
                        </a>
                      </li>
                      ...
                      <li class="layui-col-xs4">
						<a href="javascript:;" onclick="#" class="layadmin-backlog-body">
                          ...
                          <p><cite>系统</cite></p>
                          <?php else: ?>
                          <p><cite><?php echo $fzsinfo['su_title']; ?></cite></p>
                          <?php endif; ?>
                        </a>
                      </li>
                      ...
                      <li class="layui-col-xs4">
						<a href="javascript:;" onclick="#" class="layadmin-backlog-body">
                          <h3>分站赢利</h3>
                          <p><cite><?php echo round($info['su_fz_money'],2); ?></cite></p>
                        </a>
                      </li>
