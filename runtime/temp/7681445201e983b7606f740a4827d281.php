  ...
  <div class="layui-fluid">
    ...
    <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input name="phone" type="text" disabled class="layui-input" id="phone"  value="<?php echo $info['du_phone']; ?>" readonly="readonly"   placeholder="手机号">
            </div>
          </div>
