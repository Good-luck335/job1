<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"template/substation/center/index.html";i:1670029698;s:69:"/www/wwwroot/47.119.114.223_92/template/substation/common_header.html";i:1655346642;s:66:"/www/wwwroot/47.119.114.223_92/template/substation/common_top.html";i:1655179780;s:69:"/www/wwwroot/47.119.114.223_92/template/substation/common_footer.html";i:1655179778;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	  <meta charset="utf-8">
              ...
              <dl class="layui-nav-child">
                <dd data-name="console" class="layui-this">
                  <a lay-href="<?php echo url('center/home'); ?>">数据总览</a>
					...
					<li data-name="抽拥记录" class="layui-nav-item">
						<a href="javascript:;" lay-href="<?php echo url('chouyong/index'); ?>" lay-tips="抽拥记录" lay-direction="2">
							<i class="layui-icon layui-icon-auz"></i>
							<cite>抽佣记录</cite>
						</a>
					</li>
					...
					<li data-name="抽拥记录" class="layui-nav-item">
						<a href="javascript:;" lay-href="<?php echo url('chouyongtixian/index'); ?>" lay-tips="抽拥记录" lay-direction="2">
							<i class="layui-icon layui-icon-auz"></i>
							<cite>佣金提现</cite>
						</a>
					</li>
					...
					<li data-name="点卡记录" class="layui-nav-item">
						<a href="javascript:;" lay-href="<?php echo url('dianka/index'); ?>" lay-tips="点卡记录" lay-direction="2">
							<i class="layui-icon layui-icon-auz"></i>
							<cite>点卡记录</cite>
						</a>
					</li>
					
					<li data-name="扣点记录" class="layui-nav-item">
						<a href="javascript:;" lay-href="<?php echo url('diankalog/index'); ?>" lay-tips="扣点记录" lay-direction="2">
							<i class="layui-icon layui-icon-auz"></i>
							<cite>扣点记录</cite>
						</a>
					</li>
					
					<li data-name="对帐管理" class="layui-nav-item">
						<a href="javascript:;" lay-href="<?php echo url('duizhang/index'); ?>" lay-tips="对帐管理" lay-direction="2">
							<i class="layui-icon layui-icon-auz"></i>
							<cite>对帐管理</cite>
						</a>
					</li>
