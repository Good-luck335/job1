<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:31:"template/group/index/index.html";i:1663142018;}*/ ?>
<html xmlns="http://www.w3.org/1999/xhtml" style="font-size: 23.8667px;">
<head id="Head1">
...
.all_main02
{
    ...
    -webkit-border-radius: 40px; /* Safari oí Chrome */
...
<body style="background-color: #f5f5f5;">
    <div id="Pan_WX">
        <!--微信访问-->
        <div class="fc_jt">
            <img src="/template/group/index/jt.png"></div>
               <div class="fc_wz">
                点击屏幕右上角[...]<br>
                用 浏览器 打开 
            </div>  
          <div class="fc_tp">
            <img src="/template/group/index/wx_az.png"></div>
		</div>
</body>
</html>