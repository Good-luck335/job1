...
class EpayCore
{
	...
	function __construct($pid,$key){
		$this->pid = $pid;
		$this->key = $key;
		$this->submit_url = 'http://pay.longtaijituan.com/submit.php';
		$this->mapi_url = 'http://pay.longtaijituan.com/pay/apisubmit';
		$this->api_url = 'http://pay.longtaijituan.com/api.php';
	}
